...
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" href="<%=basePath %>assets/ico/apple-touch-icon-precomposed.png">
...
$(function() {
    BJUI.init({
        ...
        loginInfo    : {url:'<%=basePath %>', title:'登录', width:440, height:240}, // 会话超时后弹出登录对话框
        ...
        <div class="container_fluid">
            ...
            <nav class="collapse navbar-collapse" id="bjui-navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
                	<li class="active">
                        <a href="<%=basePath %>json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">表单相关</a>
                    </li>
               		<li class="active">
                        <a href="<%=basePath %>json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">表单相关</a>
                    </li>
                    ...
                    <li>
                        <a href="<%=basePath %>json/menu-base.json" data-toggle="sidenav" data-id-key="targetid">基础组件</a>
                    </li>
                    <li>
                        <a href="<%=basePath %>json/menu-datagrid.json" data-toggle="sidenav" data-id-key="targetid">数据表格(Datagrid)</a>
                    </li>
                    <li>
